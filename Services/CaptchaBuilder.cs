...
public static class CaptchaBuilder
{
    ...
    public static Captcha Create(string letters)
    {
        ...
        var captchaCode = GenerateCaptchaCode(configuration.Length);
    ...
    public static Captcha Create(ICaptchaConfiguration configuration)
    {
        configuration ??= new CaptchaConfiguration();

        //SetLetters(configuration.Letters);
